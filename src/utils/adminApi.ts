...
export const adminApi = {
  ...
  async getPublicClassSettings(): Promise<PublicClassSettings> {
      ...
      if (res.ok) {
        ...
        if (raw && (raw.className || raw.class_name || raw.class_date || raw.whatsapp_group_link || raw.whatsappGroupLink)) {
          return {
            ...
            classDate: raw.classDate || raw.class_date || 'Friday 5th to Sunday 7th September, 2026',
            classTime: raw.classTime || raw.class_time || '8:00 PM to 9:30 PM (WAT)',
    ...
    try {
      ...
      if (fsSettings) {
        return {
          ...
          classDate: fsSettings.class_date || 'March 27th to 29th, 2026',
          classTime: fsSettings.class_time || '8:00 PM to 9:30 PM (WAT)',
    ...
    return {
      ...
      classDate: 'March 27th to 29th, 2026',
      classTime: '8:00 PM to 9:30 PM (WAT)',
  ...
  async getClassSettings(): Promise<ClassSettings> {
    ...
    return {
      ...
      class_date: 'March 27th to 29th, 2026',
  ...
  async updateClassSettings(updates: Partial<ClassSettings>): Promise<ClassSettings> {
    ...
    const merged: ClassSettings = {
      ...
      class_date: updates.class_date || saved?.class_date || 'March 27th to 29th, 2026',
      class_time: updates.class_time || saved?.class_time || '8:00 PM to 9:30 PM (WAT)',
