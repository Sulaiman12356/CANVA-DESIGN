      ...
      if (cached) {
        ...
        if (parsed && (parsed.class_name || parsed.className || parsed.class_date || parsed.classDate)) {
          return {
            ...
            classDate: parsed.class_date || parsed.classDate || 'Saturday 12th to Monday 14th September, 2026',
    ...
    const unsubSettings = subscribeToClassSettings((liveSettings) => {
      ...
      setClassSettings((prev) => {
        const merged: any = {
          ...
          classDate: liveSettings.class_date || (prev as any)?.classDate || 'March 27th to 29th, 2026',
          classTime: liveSettings.class_time || (prev as any)?.classTime || '8:00 PM to 9:30 PM (WAT)',
